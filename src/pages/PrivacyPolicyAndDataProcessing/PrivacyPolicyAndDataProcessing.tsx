...
export const PrivacyPolicyAndDataProcessing: React.FC = () => (
    <Page title={'Política de privacidade e dados'} type={PageType.UNLOGGED}>
        <StyledContent>
            <StyledCard>
                <StyledList data-cy={'privacy-policy-and-data-processing-list'}>
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            <StyledListItem>
                                A HarvTech reconhece a importância da privacidade e proteção dos dados dos usuários de
                                seus serviços e produtos todas as informações de cuidados passados pelo sistema são
                    ...
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            <StyledListItem>
                                Os dados coletados pela HarvTech são utilizados para fornecer e melhorar os serviços e
                                produtos <StyledStrong>oferecidos aos usuários</StyledStrong>, incluindo a identificação
                                de fungos, agressores e ervas daninhas nas plantações de arroz, batata, tomate e feijão.
                            </StyledListItem>
                            <StyledListItem>
                                Além disso, os dados podem ser utilizados para gerar relatórios de boas práticas
                                agrícolas e sugestões de melhorias para resolver problemas identificados nas plantações.
                            </StyledListItem>
                        </StyledList>
                    </StyledListItem>
                    ...
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            <StyledListItem>
                                A HarvTech armazena os dados dos usuários em servidores seguros, protegidos por medidas
                                técnicas e organizacionais adequadas, para garantir a{' '}
                    ...
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            ...
                            <StyledListItem>
                                Os usuários podem exercer seus direitos entrando em contato com a HarvTech através dos
                                <StyledStrong>canais de comunicação</StyledStrong> fornecidos pela empresa como e-mail
                                ou WhatsApp.
                            </StyledListItem>
                        </StyledList>
                    </StyledListItem>
                    ...
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            <StyledListItem>
                                Ao utilizar os serviços e produtos da HarvTech, os usuários consentem com a coleta, uso,
                                armazenamento e compartilhamento de seus <StyledStrong>dados pessoais</StyledStrong>{' '}
                    ...
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            ...
                            <StyledListItem>
                                As alterações nesta política entrarão em vigor na data de sua publicação no ecossistema
                                da HarvTech ou mediante aviso aos usuários, o que ocorrer primeiro.
                            </StyledListItem>
                        </StyledList>
                    </StyledListItem>
                    ...
                    <StyledListItem isParent={true}>
                        ...
                        <StyledList>
                            <StyledListItem>
                                ...
                                política, podem entrar em contato com a <StyledStrong>HarvTech</StyledStrong> através
                                dos canais de comunicação fornecidos pela empresa.
                            </StyledListItem>
                        </StyledList>
                    </StyledListItem>
                </StyledList>
            ...
            <StyledLink href={Routes.HOME} text={'Ir para home'} />
        </StyledContent>
    </Page>
)
